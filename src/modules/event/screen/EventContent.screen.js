  ...
  useEffect(() => {
    if (
      ...
      GetDataCategory().then(response =>
        setStateDataCategory(
          response !== undefined ? response : defaultCategoryEvent,
        ),
      );
      GetDataEvent().then(response =>
        setStateDataEvent(response !== undefined ? response : defaultEvent),
      );
      ...
      GetDataSubmittedIdea(data.id).then(response =>
        setStateDataSubmitted(response !== undefined ? response : null),
      );
    }
  });
