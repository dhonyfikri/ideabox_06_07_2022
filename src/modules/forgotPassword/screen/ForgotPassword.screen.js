    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.subHeader}>Don’t worry, fill your email and we’ll send you a link to reset your password.</Text>
            </View>
            <View style={styles.inputContainer}>
                <Text style={styles.labelForm}> Email <Text style={{ color: 'red' }}>*</Text></Text>
                <TextInput
                    style={styles.input}
